<div>
    <div class="bg-white w-full rounded-lg shadow-lg flex flex-col max-h-[90vh]">
        <div
            ...
            <h1 class="text-lg font-bold text-secondary dark:text-white">{{$form->providerModel ? 'Editar' : 'Añadir'}} proveedor</h1>
        ...
        <div class="p-5 overflow-y-auto flex-1 space-y-3" style="max-height: calc(90vh - 60px);">
            <div class="grid grid-cols-2 gap-5 justify-between">
                <div class="space-y-1">
                    ...
                    <flux:input type="text" placeholder="Nombre del proveedor" wire:model="form.name" />
